            ...
            <li class="timeline_element project">
              ...
              <div class="timeline_element-contents">
                <div class="project-text">
                  <a
                    href="https://www.linkedin.com/school/holacode/"
                    class="project-link"
                  >
                    ...
                    <div class="project-subtitle">
                      This was a momentary position that lasted 8 weeks. This
              ...
              <div class="timeline_element-contents">
                <div class="project-text">
                  ...
                  >
                    ...
                    <div class="project-subtitle">
                      I completed various curriculums at FreeCodeCamp
                    </div>
                  </a>
                  <div class="project-description">
                    <p>
                      FreeCodeCamp was a starter in my full-stack web
                      development that allowed me to ge started on a lot of
                      things that I know now and the rest of the studying was
                      looking at documentation and a lot of reading.
                      Technologies like neo4j, vue, react, express node.js was
                      from self studying.
                    </p>
                  </div>
              ...
              <div class="timeline_element-contents">
                <div class="project-text">
                  <a href="https://www.calstatela.edu/" class="project-link">
                    ...
                    <div class="project-subtitle">
                      Studied at Cal State LA for a almost 2 years for a Major
                      in Computer Science
                    </div>
                  </a>
                  <div class="project-description">
                    <p>
                      I didn't complete my degree, due to some circumstances at
                      the time, this allowed me to learn the multiple things in
                      life as well as the different types of technologies and
                      paths that I can take in software development.
                    </p>
                  </div>
